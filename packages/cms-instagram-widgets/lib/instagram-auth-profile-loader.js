...
module.exports = (self, options) => {
   ...
   async function getApiClient () {
      log(`getApiClient`);
      const [authUser, authPass] = self.getApiAuth();
   ...
   async function getClient () {
      ...
      return (clientPool.length) ? clientPool.shift() : await self.getApiClient();
   }
   ...
   async function authenticatedLoadProfile (username) {
